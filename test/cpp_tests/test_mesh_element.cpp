...
TEST_CASE("Triangle Mesh Element Tests", "[triangle-mesh-element-tests]") {
    MeshVertex3D v1(-89.4717160000, 30.0866470000, 3.0000000000, 998, 273.15);
    MeshVertex3D v2(-89.4966660000, 30.0901150000, 3.9491493700, 1005, 275.15);
    MeshVertex3D v3(-89.4889400000, 30.0744220000, 1.9666023300, 1010, 277.15);
