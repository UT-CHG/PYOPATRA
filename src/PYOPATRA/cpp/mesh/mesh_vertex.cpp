...
//#include <utility>
//
//MeshVertex3D::MeshVertex(int index, int num_timesteps)
//        : MeshVertexBase<3>(index, num_timesteps)
...
//
//
//MeshVertex3D::MeshVertex(double latitude, double longitude, double bathymetric_depth, int index, int num_timesteps)
//        : MeshVertex3D::MeshVertex(index, num_timesteps)
//{
//    location(0) = latitude;
